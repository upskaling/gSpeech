...
_trans_read_selected = _('Traduire et lire la sélection')
_trans_read_clipboard = _('Traduire et lire le presse-papier')
_trans_read_ocr = _('Traduire et lire image')

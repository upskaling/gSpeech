...
from gi.repository import Gdk, GdkPixbuf, Gst, Gtk
...
def get_option_combobox(option_combobox, hbox, ind, tray, conf, menu_option):
    ...
    hbox.pack_start(option_combobox, False, False, 2)
    count = 0
...
def get_lang_combobox(lang_combobox, hbox, ind, tray, conf, menu_langs):
    ...
    hbox.pack_start(lang_combobox, False, False, 10)
    count = 0
...
def get_source_languages_combobox(
    ...
    # hbox.pack_start(label, False, False, 0)
    hbox.pack_start(source_languages_combobox, False, False, 10)
    count = 0
...
def get_engine_trans_combobox(lang_combobox, hbox, conf, menu_engine_trans):
    ...
    hbox.pack_start(label, False, False, 2)
    hbox.pack_start(lang_combobox, False, False, 2)
    count = 0
...
def get_synthesis_voice_combobox(
    ...
    hbox.pack_start(label, False, False, 2)
    hbox.pack_start(synthesis_voice_combobox, False, False, 2)
    count = 0
...
def voice_speed_box(voice_combobox, hbox, conf, menu_voice_speed):
    ...
    hbox.pack_start(label, False, False, 2)
    hbox.pack_start(voice_combobox, False, False, 2)
    count = 0
